...
#endif
newtype HappyWrap11 = HappyWrap11 (InstantParser.AbsInstant.Ident)
happyIn11 :: (InstantParser.AbsInstant.Ident) -> (HappyAbsSyn )
...
{-# INLINE happyOut12 #-}
newtype HappyWrap13 = HappyWrap13 (InstantParser.AbsInstant.Program)
happyIn13 :: (InstantParser.AbsInstant.Program) -> (HappyAbsSyn )
happyIn13 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap13 x)
{-# INLINE happyIn13 #-}
happyOut13 :: (HappyAbsSyn ) -> HappyWrap13
happyOut13 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut13 #-}
newtype HappyWrap14 = HappyWrap14 (InstantParser.AbsInstant.Stmt)
happyIn14 :: (InstantParser.AbsInstant.Stmt) -> (HappyAbsSyn )
happyIn14 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap14 x)
{-# INLINE happyIn14 #-}
happyOut14 :: (HappyAbsSyn ) -> HappyWrap14
happyOut14 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut14 #-}
newtype HappyWrap15 = HappyWrap15 ([InstantParser.AbsInstant.Stmt])
happyIn15 :: ([InstantParser.AbsInstant.Stmt]) -> (HappyAbsSyn )
happyIn15 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap15 x)
{-# INLINE happyIn15 #-}
happyOut15 :: (HappyAbsSyn ) -> HappyWrap15
happyOut15 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut15 #-}
newtype HappyWrap16 = HappyWrap16 (InstantParser.AbsInstant.Exp)
happyIn16 :: (InstantParser.AbsInstant.Exp) -> (HappyAbsSyn )
happyIn16 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap16 x)
{-# INLINE happyIn16 #-}
happyOut16 :: (HappyAbsSyn ) -> HappyWrap16
happyOut16 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut16 #-}
newtype HappyWrap17 = HappyWrap17 (InstantParser.AbsInstant.Exp)
happyIn17 :: (InstantParser.AbsInstant.Exp) -> (HappyAbsSyn )
happyIn17 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap17 x)
{-# INLINE happyIn17 #-}
happyOut17 :: (HappyAbsSyn ) -> HappyWrap17
happyOut17 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut17 #-}
newtype HappyWrap18 = HappyWrap18 (InstantParser.AbsInstant.Exp)
happyIn18 :: (InstantParser.AbsInstant.Exp) -> (HappyAbsSyn )
happyIn18 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap18 x)
{-# INLINE happyIn18 #-}
happyOut18 :: (HappyAbsSyn ) -> HappyWrap18
happyOut18 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut18 #-}
newtype HappyWrap19 = HappyWrap19 (InstantParser.AbsInstant.Exp)
happyIn19 :: (InstantParser.AbsInstant.Exp) -> (HappyAbsSyn )
happyIn19 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap19 x)
{-# INLINE happyIn19 #-}
happyOut19 :: (HappyAbsSyn ) -> HappyWrap19
happyOut19 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut19 #-}
newtype HappyWrap20 = HappyWrap20 (InstantParser.AbsInstant.Exp)
happyIn20 :: (InstantParser.AbsInstant.Exp) -> (HappyAbsSyn )
...
happyReduction_8 happy_x_1
	...
	happyIn11
		 (InstantParser.AbsInstant.Ident happy_var_1
	)}
...
happyReduction_10 happy_x_1
	...
	happyIn13
		 (InstantParser.AbsInstant.Prog happy_var_1
	)}
...
happyReduction_11 happy_x_3
	...
	happyIn14
		 (InstantParser.AbsInstant.SAss happy_var_1 happy_var_3
	)}}
...
happyReduction_12 happy_x_1
	...
	happyIn14
		 (InstantParser.AbsInstant.SExp happy_var_1
	)}
...
happyReduction_16 happy_x_3
	...
	happyIn16
		 (InstantParser.AbsInstant.ExpAdd happy_var_1 happy_var_3
	)}}
...
happyReduction_18 happy_x_3
	...
	happyIn17
		 (InstantParser.AbsInstant.ExpSub happy_var_1 happy_var_3
	)}}
...
happyReduction_20 happy_x_3
	...
	happyIn18
		 (InstantParser.AbsInstant.ExpMul happy_var_1 happy_var_3
	)}}
...
happyReduction_21 happy_x_3
	...
	case happyOut19 happy_x_3 of { (HappyWrap19 happy_var_3) -> 
	happyIn18
		 (InstantParser.AbsInstant.ExpDiv happy_var_1 happy_var_3
	)}}
...
happyReduction_23 happy_x_1
	...
	happyIn19
		 (InstantParser.AbsInstant.ExpLit happy_var_1
	)}
...
happyReduction_24 happy_x_1
	 =  case happyOut11 happy_x_1 of { (HappyWrap11 happy_var_1) -> 
	happyIn19
		 (InstantParser.AbsInstant.ExpVar happy_var_1
	)}
